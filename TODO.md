...
- [ ] Initialize Go module: `go mod init kvstore`
...
- [ ] Design the Entry struct (operation, timestamp, key, value)
- [ ] Implement binary encoding/decoding functions (use `encoding/binary` package)
